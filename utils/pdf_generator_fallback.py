...
def generate_html_report(markdown_content: str, symbol: str, output_dir: str = "reports") -> str:
    """
    生成HTML格式的报告（WeasyPrint不可用时的替代方案）
    ...
    <body>
        ...
        <div class="print-instruction">
            <strong>打印说明：</strong> 由于系统环境限制，PDF生成功能不可用。
            此HTML文件已优化打印格式，请按以下步骤操作：
            <ol>
                <li>按 <kbd>Ctrl+P</kbd> 打开打印对话框</li>
                <li>选择打印机为 "Microsoft Print to PDF" 或 "另存为PDF"</li>
                <li>设置纸张大小为 A4，边距为 "窄" 或 "无"</li>
                <li>勾选 "背景图形" 选项（确保样式正确）</li>
                <li>点击打印/保存生成PDF文件</li>
            </ol>
        </div>
